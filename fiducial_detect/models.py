#AUTOGENERATED! DO NOT EDIT! File to edit: dev/models.ipynb (unless otherwise specified).
...
#Cell
def get_encoder(layout_encoder):
    return nn.Sequential(*[conv_layer(*layout_conv) for layout_conv in layout_encoder])
